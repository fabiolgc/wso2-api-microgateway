...
function initThrottlePolicies() {
    ...
    future<()> initResource1KPerMinPolicyFtr = start initResource1KPerMinPolicy();

    log:printDebug("Throttle policies initialized.");
}

function getDeployedPolicies() returns map<boolean> {
    return { "50PerMin":true,"20PerMin":true,"10PerMin":true,"Gold":true,"Silver":true,"Bronze":true,"Unauthenticated":true,"50kPerMin":true,"20kPerMin":true,"10kPerMin":true,"1KPerMin":true };
}