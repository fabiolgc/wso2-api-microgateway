...
import wso2/gateway;
     ...
     http:Client get_ad31b08b_e902_4e41_bcb4_fc3d9364f856_prod = new (
...
secureSocket:{
    trustStore: {
     ...
     http:Client get_c1329a61_7aed_4a04_a7cb_4defd7447ac9_prod = new (
...
apiSecureListener {
    ...
    resource function get_ad31b08b_e902_4e41_bcb4_fc3d9364f856 (http:Caller outboundEp, http:Request req) {
    ...
    clientResponse = get_ad31b08b_e902_4e41_bcb4_fc3d9364f856_prod->forward(urlPostfix, req);
...
clientResponse = res;
    ...
    @gateway:RateLimit{policy : "1KPerMin"}
    resource function get_c1329a61_7aed_4a04_a7cb_4defd7447ac9 (http:Caller outboundEp, http:Request req) {
        handleExpectHeaderForKindel_Book_Store__1_0_0(outboundEp, req);
            ...
            if (etcdKey != "" && gateway:etcdConnectionEstablished) {
                ...
                log:printError("Error in checking for Re-initialization", err = hasUrlChanged);
                        ...
                        //destination_attribute = <string>gateway:etcdUrls[etcdKey];
                         var err = trap
get_c1329a61_7aed_4a04_a7cb_4defd7447ac9_prod.__init
...
secureSocket:{
    ...
    if (!reinitFailed) {
        clientResponse = get_c1329a61_7aed_4a04_a7cb_4defd7447ac9_prod->forward(urlPostfix, req);
    }
