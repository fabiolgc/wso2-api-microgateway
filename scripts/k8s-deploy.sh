...
#${KUBERNETES_CLIENT} create -f ../k8s/etcd-deployment.yaml
#${KUBERNETES_CLIENT} create -f ../k8s/etcd-service.yaml


echoBold 'Deploying Microervices (backend)'
${KUBERNETES_CLIENT} create -f ../k8s/book-list-deployment.yaml
${KUBERNETES_CLIENT} create -f ../k8s/book-list-service.yaml
...
${KUBERNETES_CLIENT} create -f ../k8s/gateway-ingress.yaml
